...
public class ShowPhasesPLDTest {
	Gui testGui;
	...
	public void test() {
	    ...
	    for (int i=0; i<projects.length; i++) {
		    ...
		    String filename = "NewData/NewShowPhasesPLDInfo_" + projects[i] + ".txt";
		    PrintStream gui;
			try {
			...
			File file1 = new File("OldData/OldShowPhasesPLDInfo_" + projects[i] + ".txt");
		    File file2 = new File("NewData/NewShowPhasesPLDInfo_" + projects[i] + ".txt");
