...
public class GeneralTablePhases {
	...
	public void makeGeneralTablePhases() {
		...
		generalTable.setDefaultRenderer(Object.class, new DefaultTableCellRenderer()
		{
		    ...
		    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column)
		    {
		        ...
		        if(column==wholeCol && wholeCol!=0){
		        	String description = descriptionGenerator.generateMakeGeneralTablePhasesDescription(tmpValue,finalRows,globalDataKeeper, wholeCol, selectedColumn);
		...
		jItemsHandler.setJScrollPanePosition(tmpScrollPane, 300, 30, 950, 265);
	...
	private void showClusterSelectionToZoomArea(int selectedColumn,String selectedCluster){
		...
		gui.makeZoomAreaTableForCluster(finalColumnsZoomArea,finalRowsZoomArea); // extract, need it in gui also
	}
	...
	private void showSelectionToZoomArea(int selectedColumn){
		...
		tabbedPane = gui.getTabbedPane();
		tabbedPane.setSelectedIndex(0);
		gui.makeZoomAreaTable(finalColumnsZoomArea,finalRowsZoomArea); // extract it only here is used
	}
